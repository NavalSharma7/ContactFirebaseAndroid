...
//
//                            DocumentReference contactRef = FirebaseFirestore.getInstance().collection("Contacts").document(contact.getName());
//                   //ContactInfo contactUpdate = new ContactInfo(edtEditName.getText().toString(),edtEditEmail.getText().toString(),edtEditPhone.getText().toString(),uri,contact.getPath());
//                            contactRef.update(edtEditEmail.getText().toString(),edtEditName.getText().toString(),edtEditPhone.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
//                                @Override
...
//                                    }
//                                    else{
//                                        Toast.makeText(EditContactActivity.this, "Contact updation failed", Toast.LENGTH_SHORT).show();
//
//                                    }
//                                }
//                            });
...
//                        }
//
                    String docId = String.format("%s",contact.getId());
                    DocumentReference contactRef = FirebaseFirestore.getInstance().collection("Contacts").document(docId);
                            contactRef.update("email",edtEditEmail.getText().toString(),"name",edtEditName.getText().toString(),"phone",edtEditPhone.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(EditContactActivity.this, "Contact edited", Toast.LENGTH_SHORT).show();
